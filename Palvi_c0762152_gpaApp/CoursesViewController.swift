...
/// Enum to get graade point value for particular grade
enum Grade: Double {
    case APlus = 4.0
    case A = 3.7
    case AMinus = 3.5
...
/// Protocol for Courses View Controller
...
class CoursesViewController: UIViewController {
    ...
    func calculateTotalGPA() {
        ...
        //credits all plus ,plus all gpa /20
    ...
    /// - Parameters:
    ///   - courseName: String - Name of the cours
    ///   - credit: Double - Credit of the particular course
    ///   - mark: Double - Marks obtained in that course
